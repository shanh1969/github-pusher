...
export default function Home() {
  ...
  const modelOptions = [
    ...
    { id: 'gemini-2.0-flash-exp', name: 'Gemini 2.0 Flash Exp', desc: 'Latest & free', provider: 'gemini' },
    { id: 'gemini-exp-1206', name: 'Gemini Exp 1206', desc: 'Experimental', provider: 'gemini' },
